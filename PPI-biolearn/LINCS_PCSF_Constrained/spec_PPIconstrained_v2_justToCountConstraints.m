...
%march 31 [Specfilename] = spec_PPIconstrained_v2_justToCountConstraints(networkname,filelist,variable_names,ppi);
% BL is hanging (7 hours so far on first iteraration - so I'm checking that I didnt accidentally eliminate any possible edges :)
% checks out correctly ount_edges =
% 
%        78606
% 
% 
...
function spec_PPIconstrained_v2(networkname,filelist,variable_names,ppi);
