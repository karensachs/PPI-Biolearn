%start with extract_BLedge_manual.m and smooth over a few details, to
%generalize if someone wants to load their own set of edges and nodes
%K.Sachs April 2020
...
%first edge/pilot:
% % % % % % findcol=strfind(nodes,'EIF1AY'); %eliminated in this version
...
% % % % edgelist_webweb(1,:)=[398 geneindex1];eliminates this version
%fill edge_lsit
for i=1:length(BLextracted_edges)
    for col=1:2
